...
shell_exec( "pdftohtml -f 167 -l 187 $nomFichier PCG.html" );

# Lecture du texte résultat
$text = file_get_contents( 'PCGs.html' );

# Extraction du texte pour la classe 8
shell_exec( "pdftohtml -f 223 -l 224 $nomFichier PCG.html" );
...
#foreach( array( 'base', 'étendu' ) as $system ) {
	...
	file_put_contents( "PCG_2014-03_v2017-01-01_$system-gnucash.xml", $output );
}
